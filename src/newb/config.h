...
/* Waving */
#define NL_PLANTS_WAVE 0.00   // [toggle] 0.02 gentle ~ 0.4 violent
#define NL_LANTERN_WAVE 0.04   // [toggle] 0.05 subtle ~ 0.4 large swing
#define NL_WAVE_SPEED 3.7      // 0.5 slow wave ~ 5.0 very fast wave
//#define NL_EXTRA_PLANTS_WAVE // [toggle] !dont use! wave using texture coords (1.21.0 vanilla 2048x1024)

/* Water */
#define NL_WATER_TRANSPARENCY 0.0 // 0.0 transparent ~ 1.0 normal
...
#define NL_AURORA_WIDTH 1.20    // 0.04 thin line ~ 0.4 thick lines
